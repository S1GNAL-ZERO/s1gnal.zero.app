...
public class WallOfShameView extends VerticalLayout {
    ...
    private void createHeader() {
        ...
        // Logo badge with binary shield
        Div logoBadge = createBinaryShieldLogo();
        logoBadge.addClassName("logo-badge");
        logoBadge.getStyle().set("width", "3rem");
        logoBadge.getStyle().set("height", "3rem");
    ...
    private Div createBinaryShieldLogo() {
        ...
        logoDiv.getElement().setProperty("innerHTML", 
            ...
            "<defs>" +
            "<linearGradient id=\"wallLogoGrad\" x1=\"0%\" y1=\"0%\" x2=\"100%\" y2=\"100%\">" +
